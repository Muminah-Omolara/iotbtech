...
const OurServiceWithImage = ({title, description, img}) => {
    return (
        <div
            className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-5"
        >
            <div className="flex flex-col space-y-6">
                ...
                <p className="text-tt-grey text-lg max-w-3xl">{description}</p>

            </div>
            <div className="relative">
                <img src={img} alt="the things we do" className="object-contain"/>
                <img
                    src={titik}
                    alt="pattern"
