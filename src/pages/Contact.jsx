  ...
  return (
    <div className='mx-auto leading-snug w-auto max-w-5xl px-4 py-4 lg:px-0 lg:py-2 sm:px-4 gap-9 flex flex-col md:flex-row justify-center items-center min-h-screen'>
        ...
        <div className='lg:w-[537px] md:w-[398px] relative  p-11'>
            ...
            <p className='lg:text-center md: text-left font-bold text-tt-primary text-[22px]'>Let's have a chat</p>
            <h1 className='lg:text-center md: text-left font-bold text-tt-black text-[30px]'>An expert at your services</h1>
            </div>
