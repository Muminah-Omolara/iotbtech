  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-between p-6 lg:p-16 max-w-6xl mx-auto lg:mt-5 mt-14">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" version="1.1" 
            ...
            viewBox="0 0 800 800" className="hidden lg:block absolute -left-[120px] w-[400px] h-[400px] lg:w-[520px] lg:h-[380px] z-0">
                <g strokeWidth="7" stroke="#008080" fill="none" strokeLinecap="square" 
                    strokeDasharray="13 24" transform="matrix(0.6427876096865394,0.766044443118978,-0.766044443118978,0.6427876096865394,462.30273337297547,-197.532821122207)">
                        <path d="M151.3367612361908 150.03457641601562Q132.3367612361908 681.0345764160156 649.3367612361908 648.0345764160156 " 
                            markerEnd="url(#SvgjsMarker8558)">
                        </path>
                </g>
                <defs><marker markerWidth="5" markerHeight="5" refX="2.5" refY="2.5" 
                    viewBox="0 0 5 5" orient="auto" id="SvgjsMarker8558">
        ...
        <div className="relative lg:w-1/2 flex justify-center z-10">
            ...
            <img src={patternCircles} alt="patter circles background"
