...
import "../App.css";
import {cloudIcon, colorPalette, hexagon, titik, uiUx, vector, webIcon,} from "../assets/icons";
...
const Hero = () => {
    return (
        <div
            className="flex flex-col lg:flex-row items-center justify-between p-6 lg:p-16 max-w-screen-xl mx-auto lg:mt-5 mt-14 ">
            <div className="lg:w-1/2 text-center lg:text-left relative">
                ...
                <div className="space-y-6">
                    ...
                    <h1 className="text-tt-black text-left text-4xl md:text-5xl font-extrabold mb-8">
                        On a mission to liberate lives{" "}
                        <IOTBBadge/>
                    </h1>
                    <p className="text-xl text-tt-grey mb-6 text-left">
                        Empowering Nigerian youths with in-demand tech skills, the IOTB TECH Fellowship is a 6-month
                        program offering training in selected tech fields, fostering career growth and development.
                    </p>
                    <div
                        className="flex flex-col lg:flex-row mx-auto justify-center lg:justify-start mt-9 mb-8 gap-5 -z-50">
