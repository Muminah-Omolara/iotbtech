            ...
            <div className="max-w-screen-xl mx-auto">
                <div className="flex flex-col items-left justify-left">
                    ...
                    <div className="flex flex-col lg:flex-row gap-8 text-left lg:text-left mt-4">
                        <h3 className="text-tt-black text-3xl font-bold mb-0 lg:mb-8 max-w-screen-lg">Our Working
                            Process
                            help you to get the best from our team skill</h3>
                ...
                <div
                    className="flex flex-col lg:flex-row gap-3 items-stretch justify-between w-full lg:my-32">
                    {processes.map((s, idx) => (
