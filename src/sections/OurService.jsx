  ...
  return (
    <div className="px-4 md:px-8 mb-8">
      <div className="max-w-screen-xl mx-auto flex-col items-center justify-center text-left lg:text-center space-y-6">
        ...
        <h1 className="text-tt-black text-3xl font-bold mb-0 lg:mb-8">
          Services we Offer
        </h1>
        <p className="text-tt-grey text-lg lg:text-md text-justify">
          With our awesome team we offers a variety of services from UI/UX
          design to cloud solutions architecture. we offer holistic trainings 
          that helps you achieve your goals of skills development and professional breakthrough.
        </p>
